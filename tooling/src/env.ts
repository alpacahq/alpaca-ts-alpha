...
/**
 * Prepend a JDK `bin` directory to PATH, but only after validating it is an
 * absolute path that actually contains a `java` executable. This prevents an
 * unexpected/empty value (e.g. from `java_home`) from poisoning PATH.
 */
